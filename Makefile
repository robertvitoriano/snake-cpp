...
SDL_FLAGS = $(shell sdl2-config --cflags --libs) -lSDL2_image -lSDL2_mixer

BUILD_DIR = build
SRC_DIR = src
OBJECTS = $(BUILD_DIR)/main.o $(BUILD_DIR)/Snake.o $(BUILD_DIR)/Food.o $(BUILD_DIR)/Game.o $(BUILD_DIR)/Renderer.o $(BUILD_DIR)/MusicPlayer.o
...
$(BUILD_DIR)/Game.o: $(SRC_DIR)/Game.cpp $(SRC_DIR)/Game.h $(SRC_DIR)/Snake.h $(SRC_DIR)/Food.h $(SRC_DIR)/Renderer.h $(SRC_DIR)/MusicPlayer.h
